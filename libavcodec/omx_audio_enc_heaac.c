...
FFCodec ff_xheaac_omx_encoder = {
        .p.name             = "omx_enc_xheaac",
        .p.long_name        = NULL_IF_CONFIG_SMALL("OMX IL HE-AAC Encoder"),
        ...
        .p.capabilities     = AV_CODEC_CAP_DELAY | AV_CODEC_CAP_DR1 | AV_CODEC_CAP_SMALL_LAST_FRAME | AV_CODEC_CAP_NON_INTRA,
        .defaults           = heaac_enc_omx_defaults,
        .p.priv_class       = &omx_xheaac_encoder_class,
