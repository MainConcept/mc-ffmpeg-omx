...
static int omx_set_audio_mpegh_param(AVCodecContext *avctx)
{
    ...
    audio_param_aac.nChannels = avctx->ch_layout.nb_channels;
...
static const FFCodecDefault heaac_enc_omx_defaults[] = {
        { NULL },
};
...
FFCodec ff_mpegh_omx_encoder = {
        .p.name            = "omx_enc_mpegh",
        .p.long_name       = NULL_IF_CONFIG_SMALL("OMX IL MPEG-H Encoder"),
        ...
        .p.capabilities    = AV_CODEC_CAP_VARIABLE_FRAME_SIZE | AV_CODEC_CAP_DELAY | AV_CODEC_CAP_DR1 | AV_CODEC_CAP_PARAM_CHANGE,
        .defaults          = heaac_enc_omx_defaults,
        .p.priv_class      = &omx_mpegh_encoder_class,
